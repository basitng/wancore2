  ...
  const qualities = [
    {
      ...
      id: nanoid(),
      content: `Hyperlink Technologies has garnered huge experience in deploying wireless solutions ranging from wireless LAN to wireless LAN bridging in campus environment and metropolitan wireless backhaul for Data, Voice and Video transmission.
...

    {
      ...
      GSM and Mobile internet service providers in their plight to improve their services often result to laying Optical Fiber across the metropolis. Hyperlink Technologies is well positioned to provide them consultancy services, project management services or the actual implementation of the project.`,
      icon: <WifiOutlined sx={{ color: "#fff" }} />,
    ...
    },
    {
      ...
      content: `Our structured cabling system provides a universal platform upon which an overall information systems strategy is built.
        ...
        Through the years, Hyperlink Technologies has gone into alliances with major global cable manufacturing companies. The business model of the company is anchored on partnering with the best-in-class global companies, for their best products and services and delivering them to our customers in the best manner, using the best people.`,
      icon: <WifiOutlined sx={{ color: "#fff" }} />,
      color: "--color-red",
